...
import kotlinx.android.synthetic.main.ucrop_activity_photobox1.*

/**
 * Created by Rahul Mandaliya
 */
class UCropActivity1 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ucrop_activity_photobox1)

        recyclerViewSize.layoutManager = LinearLayoutManager(applicationContext, LinearLayoutManager.HORIZONTAL, false)
