...
import com.yalantis.ucrop.adapter.SizeAdapter;

/**
 * Created by Rahul Mandaliya
 */

public class UCropActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerViewSize.setLayoutManager(new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.HORIZONTAL, false));
        recyclerViewSize.setAdapter(new SizeAdapter(getApplicationContext()));
    }
...
//
//        mCompressQuality = intent.getIntExtra(UCrop.Options.EXTRA_COMPRESSION_QUALITY, UCropActivity1.DEFAULT_COMPRESS_QUALITY);
//
//        // Gestures options
